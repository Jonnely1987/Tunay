                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="relative w-full mb-3">
                        ...
                        <input type="email" id="email" class="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none 
                          form-control @error('email') is-invalid @enderror focus:ring w-full " required autocomplete="email"placeholder="Email"
                          style="transition: all 0.15s ease 0s;"/>
                    </div>
                                @error('email')
                    ...
                    <div class="relative w-full mb-3">
                      <label
                        ...
                        text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full form-control @error('password') is-invalid @enderror"
                        required autocomplete="current-password" placeholder="Password"style="transition: all 0.15s ease 0s;"/>
                    </div>
                    @error('password')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
